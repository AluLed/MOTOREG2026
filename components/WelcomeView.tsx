...
import { ArrowRight, Radio, FileText, List } from 'lucide-react';
...
const WelcomeView: React.FC<WelcomeViewProps> = ({ onGoToRegistration, onGoToTransponder, onViewPublicList }) => {
  return (
