  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
      <div className="bg-slate-900 px-6 py-6 border-b border-slate-700">
        <h2 className="text-lg sm:text-xl font-bold text-white flex items-center justify-center gap-2 mb-2 text-center whitespace-nowrap overflow-hidden">
          <Award className="text-orange-500 w-5 h-5 sm:w-6 sm:h-6 shrink-0" />
